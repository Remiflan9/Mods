    ...
    public class CurseOfTheBoomalopes : CurseWorker
    {
        ...
        public static void Prefix(DamageInfo? dinfo, Pawn __instance, Hediff exactCulprit = null)
        {
            if (__instance.RaceProps.Animal)
            {
                ...
                GenExplosion.DoExplosion(__instance.Position, __instance.Map, radius, DamageDefOf.Flame, __instance, -1, -1f, null, null, null, null, null, 0f, 1, GasType.Unused, false, null, 0f, 1, 0f, false, null, null);
            }
        }
    }
}
