...
public class MassUtilityCaching : ClassWithFishPatches
{
	...
	public struct GearMassCacheValue
	{
		...
		{
			this.mass = mass;
			_nextRefreshTick = Current.Game.tickManager.TicksGame + 3072 + Math.Abs(FishSettings.nextRandInt % 2048);
	...
	public struct InventoryMassCacheValue
	{
		...
		{
			this.mass = mass;
			_nextRefreshTick = Current.Game.tickManager.TicksGame + 256 + Math.Abs(FishSettings.nextRandInt % 256);
