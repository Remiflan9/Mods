...
#pragma warning restore CS8618
	...
	public struct RecipeIngredientCacheValue
	{
		...
		public RecipeIngredientCacheValue(IngredientCacheList thingDefs)
		{
			...
			_nextRefreshTick = Current.Game.tickManager.TicksGame + 384 + Math.Abs(FishSettings.nextRandInt % 256);
		}

		public bool ShouldRefreshNow
		{
			get => _nextRefreshTick < Current.Game.tickManager.TicksGame;
			set => _nextRefreshTick = value ? 0 : Current.Game.tickManager.TicksGame + 384 + Math.Abs(FishSettings.nextRandInt % 256);
		}
	}
}