...
{
    public class WorkGiver_GrowerHarvestSandy : WorkGiver_GrowerSandy
    {
        ...
        public override bool HasJobOnCell(Pawn pawn, IntVec3 c, bool forced = false)
        {
            ...
            Zone_GrowingSandy zone_Growing = c.GetZone(pawn.Map) as Zone_GrowingSandy;
            if (zone_Growing != null && !zone_Growing.allowCut && plant.def != WorkGiver_GrowerSandy.wantedPlantDef)
            {
                return false;
            }
        ...
        public override Job JobOnCell(Pawn pawn, IntVec3 c, bool forced = false)
        {
            ...
            for (int i = 0; i < 40; i++)
            {
                ...
                if (!(intVec != c) || plant.def == WorkGiver_GrowerSandy.CalculateWantedPlantDef(intVec, map))
                {
