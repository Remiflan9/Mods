...
{
    public class WorkGiver_GrowerHarvestAquatic : WorkGiver_GrowerAquatic
    {
        ...
        public override bool HasJobOnCell(Pawn pawn, IntVec3 c, bool forced = false)
        {
            ...
            Zone_GrowingAquatic zone_Growing = c.GetZone(pawn.Map) as Zone_GrowingAquatic;
            if (zone_Growing != null && !zone_Growing.allowCut && plant.def != WorkGiver_GrowerAquatic.wantedPlantDef)
            {
                return false;
            }
        ...
        public override Job JobOnCell(Pawn pawn, IntVec3 c, bool forced = false)
        {
            ...
            for (int i = 0; i < 40; i++)
            {
                ...
                if (!(intVec != c) || plant.def == WorkGiver_GrowerAquatic.CalculateWantedPlantDef(intVec, map))
                {
